        ...
        <CardContent>
          <ScrollArea className="h-[60vh]">
            <div className="space-y-2">
              ...
              {items.slice((page - 1) * pageSize, page * pageSize).map((n) => (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        {!n.read && (
                          <Button size="sm" variant="outline" onClick={() => dispatch(markRead(n.deliveryId))}>
                            Mark read
                          </Button>
                        )}
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button disabled={items.length <= page * pageSize} onClick={() => setPage((p) => p + 1)}>Next</Button>
            </div>
          </div>
        </CardContent>
      </Card>

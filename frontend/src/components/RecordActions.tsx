...
//   SendApprovalDialog,
// } from "./dialogs";
// import { useArchiveRecord, useDeleteRecord, useRestoreRecord } from "@/lib/masterRecord/hooks";

// export function RecordActions({ record }: { record: any }) {
...
//         name={record.id}
//         onConfirm={() =>
//           sendApprovalMutation.mutate(record.id, {
//             onSuccess: () => setOpenSendApproval(false),
//           })
//         }
//       /> */}
//     </>

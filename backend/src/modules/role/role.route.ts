...
router.patch(
  "/bulk/archive",
  validate(roleIdsSchema, "body"),
  asyncHandler(roleController.archiveRoles)
);
router.patch(
  "/bulk/restore",
  validate(roleIdsSchema, "body"),
  asyncHandler(roleController.restoreRoles)
);
router.delete(
  "/bulk",
  validate(roleIdsSchema, "body"),
  asyncHandler(roleController.deleteRoles)
);
...
router.put(
  ...
  asyncHandler(roleController.updateRoleById)
);
router.patch(
  "/:roleId/archive",
  validate(roleIdSchema, "params"),

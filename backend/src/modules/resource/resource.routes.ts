...
router.get("/:resourceId/fields", resourcesController.getFields);
router.put(
  "/:resourceId",
  validate(resourceIdSchema, "params"),
...
router.get("/:id/schema", resourcesController.getResourceSchema);
router.get("/by-field/:fieldId", resourcesController.getReferenceData);
router.get("/:id/search", resourcesController.searchReference);
router.post("/:id/validate", resourcesController.validateReference);

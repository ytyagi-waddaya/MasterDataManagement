...
router.patch(
  "/:workflowId/archive",
  asyncHandler(workflowController.archiveWorkflow)
);

router.patch(
  "/:workflowId/restore",
  asyncHandler(workflowController.restoreWorkflow)
);
...
router.post(
  "/:workflowId/stages",
  asyncHandler(workflowController.createStages)
);
...
router.get(
  ...
  asyncHandler(workflowController.getStage)
);

router.patch(
  "/:workflowId/stage/:stageId",
  asyncHandler(workflowController.updateStage)
);

router.delete(
  "/:workflowId/stage/:stageId",
  asyncHandler(workflowController.deleteStage)
);
...
router.post(
  ...
  asyncHandler(workflowController.createTransitions)
);

router.get(
  "/:workflowId/transitions",
  asyncHandler(workflowController.getTransitions)
);

router.get("/:workflowId/transition/:transitionId",
  asyncHandler(workflowController.getTransition)
);

router.patch(
  "/:workflowId/transition/:transitionId",
  asyncHandler(workflowController.updateTransition)
);

router.delete(
  "/:workflowId/transition/:transitionId",
  asyncHandler(workflowController.deleteTransitions)
);
...
router.get(
  ...
  asyncHandler(workflowController.listByWorkflow)
);

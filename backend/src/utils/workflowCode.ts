 ...
 */
export function generateWorkflowCode(name: string): string {
 ...
 */
export async function generateNextWorkflowVersion(
  code: string,
 ...
 */
export async function generateWorkflowCodeAndVersion(
  name: string,
  tx: Prisma.TransactionClient | typeof prisma = prisma
) {
...
export async function generateStageCode(
  workflowId: string,
  name: string,
  tx: Prisma.TransactionClient | typeof prisma = prisma
) {

...
const policyController = {
    ...
    createPoliciesBulk: async (req, res) => {
        const data = req.body;
    ...
    softDeleteManyPolicies: async (req, res) => {
        const ids = { id: req.body.ids };
        if (!ids.id?.length)
    ...
    restoreManyPolicies: async (req, res) => {
        const ids = { id: req.body.ids };
        if (!ids.id?.length)
            throw new BadRequestException("Policy IDs are required");
    ...
    deleteManyPolicies: async (req, res) => {
        const ids = { id: req.body.ids };
        if (!ids.id?.length)
            throw new BadRequestException("Policy IDs are required");

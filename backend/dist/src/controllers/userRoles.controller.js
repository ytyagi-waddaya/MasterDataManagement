...
const userRolesController = {
    assignUserRole: async (req, res) => {
        ...
        const userRole = await userRolesService.assignUserRole({ userId }, { roleId }, {
    ...
    assignUserRolesBulk: async (req, res) => {
        const data = req.body;
    ...
    revokeUserRole: async (req, res) => {
        ...
        const revoked = await userRolesService.revokeUserRole({ userId }, { roleId }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    revokeUserRolesBulk: async (req, res) => {
        const data = req.body;

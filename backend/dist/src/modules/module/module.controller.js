...
const moduleController = {
    ...
    archiveModule: async (req, res) => {
        ...
        const module = await moduleService.archiveModule({ moduleId }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    restoreModule: async (req, res) => {
        ...
        const module = await moduleService.restoreModule({ moduleId }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    deleteModule: async (req, res) => {
        ...
        const module = await moduleService.deleteModule({ moduleId }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    archiveModules: async (req, res) => {
        const { moduleIds } = req.body;
        const modules = await moduleService.archiveModules({ moduleIds }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    restoreModules: async (req, res) => {
        const { moduleIds } = req.body;
        const modules = await moduleService.restoreModules({ moduleIds }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    deleteModules: async (req, res) => {
        const { moduleIds } = req.body;
        const modules = await moduleService.deleteModules({ moduleIds }, {
            actorId: req.user?.id ?? null,
            ipAddress: req.ip,
            userAgent: req.get("user-agent") ?? null,
            performedBy: PerformedByType.USER,
    ...
    getModulesWithResources: async (req, res) => {

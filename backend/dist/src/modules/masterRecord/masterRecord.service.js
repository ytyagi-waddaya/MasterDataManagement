import { AuditAction, AuditEntity, PerformedByType, SchemaStatus, } from "../../../prisma/generated/client.js";
...
const masterRecordService = {
    ...
    //   }
    // },
    createRecord: async (masterObjectId, data, meta) => {
        const userId = meta?.actorId;
        if (!userId)
        ...
        if (!schema) {
            throw new BadRequestException("No published schema found for this MasterObject");
        }
    ...
    archiveRecord: async (recordId, meta) => {
    ...
    restoreRecord: async (recordId, meta) => {
        const existing = await masterRecordRepository.readOne(recordId);
        if (!existing)
            throw new NotFoundException("Record not found.");
    ...
    deleteRecord: async (recordId, meta) => {
        const existing = await masterRecordRepository.readOne(recordId);
        if (!existing)
            throw new NotFoundException("Record not found.");
...
//   }
// },
//# sourceMappingURL=masterRecord.service.js.map
...
const masterRecordController = {
    createMasterRecord: async (req, res) => {
        const { masterObjectId, data } = req.body;
        const record = await masterRecordService.createRecord(masterObjectId, data, {
    ...
    getMasterRecords: async (req, res) => {
    ...
    archiveMasterRecord: async (req, res) => {
        const recordId = req.params?.recordId;
        if (!recordId) {
    ...
    restoreMasterRecord: async (req, res) => {
        const recordId = req.params?.recordId;
        if (!recordId) {
            throw new BadRequestException("Record Id is required");
        }
    ...
    deleteMasterRecord: async (req, res) => {
        const recordId = req.params?.recordId;
        if (!recordId) {
            throw new BadRequestException("Record Id is required");
        }
...
//# sourceMappingURL=masterRecord.controller.js.map
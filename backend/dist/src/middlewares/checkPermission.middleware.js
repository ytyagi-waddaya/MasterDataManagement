...
async function resolveField(field, context) {
    if (field.startsWith("user."))
        return deepGet(context.user, field.slice(5));
    ...
    if (field.startsWith("$"))
        return context.contextVars[field];
    return undefined;
}

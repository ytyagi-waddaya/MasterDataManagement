...
export type GetMasterRecordAggregateType<T extends MasterRecordAggregateArgs> = {
    [P in keyof T & keyof AggregateMasterRecord]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateMasterRecord[P]> : Prisma.GetScalarType<T[P], AggregateMasterRecord[P]>;
};
...
type GetMasterRecordGroupByPayload<T extends MasterRecordGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<MasterRecordGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof MasterRecordGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], MasterRecordGroupByOutputType[P]> : Prisma.GetScalarType<T[P], MasterRecordGroupByOutputType[P]>;
}>>;
...
export type MasterRecordCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<MasterRecordFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MasterRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['MasterRecord'];
        meta: {
            name: 'MasterRecord';
        };
    };
     ...
     * })
    **/
    count<T extends MasterRecordCountArgs>(args?: Prisma.Subset<T, MasterRecordCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], MasterRecordCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends MasterRecordGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, MasterRecordGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMasterRecordGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=MasterRecord.d.ts.map
...
-- CreateEnum
CREATE TYPE "FieldValidationType" AS ENUM ('REQUIRED', 'REQUIRED_IF', 'REGEX', 'MIN', 'MAX', 'BETWEEN', 'EMAIL', 'RANGE', 'LENGTH', 'CUSTOM');
...
-- CreateEnum
CREATE TYPE "HistoryAction" AS ENUM ('TRANSITION', 'APPROVAL_REQUESTED', 'APPROVED', 'REJECTED', 'SENT_BACK', 'REVIEWED', 'AUTO_TRANSITION', 'REOPENED');

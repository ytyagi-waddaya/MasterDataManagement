...
// @ts-nocheck 
/*
 * This file exports the `SchemaChange` model and its related types.
 *
...
export type GetSchemaChangeAggregateType<T extends SchemaChangeAggregateArgs> = {
      [P in keyof T & keyof AggregateSchemaChange]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSchemaChange[P]>
    : Prisma.GetScalarType<T[P], AggregateSchemaChange[P]>
}
...
type GetSchemaChangeGroupByPayload<T extends SchemaChangeGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SchemaChangeGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SchemaChangeGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SchemaChangeGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SchemaChangeGroupByOutputType[P]>
      }
    >
  >
...
export type SchemaChangeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SchemaChangeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SchemaChangeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SchemaChange'], meta: { name: 'SchemaChange' } }
  /**
   ...
   * })
  **/
  count<T extends SchemaChangeCountArgs>(
    args?: Prisma.Subset<T, SchemaChangeCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SchemaChangeCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SchemaChangeGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SchemaChangeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSchemaChangeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

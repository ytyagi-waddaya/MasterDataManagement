...
// @ts-nocheck 
/*
 * This file exports the `FieldFormula` model and its related types.
 *
...
export type GetFieldFormulaAggregateType<T extends FieldFormulaAggregateArgs> = {
      [P in keyof T & keyof AggregateFieldFormula]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFieldFormula[P]>
    : Prisma.GetScalarType<T[P], AggregateFieldFormula[P]>
}
...
type GetFieldFormulaGroupByPayload<T extends FieldFormulaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FieldFormulaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FieldFormulaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FieldFormulaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FieldFormulaGroupByOutputType[P]>
      }
    >
  >
...
export type FieldFormulaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FieldFormulaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FieldFormulaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FieldFormula'], meta: { name: 'FieldFormula' } }
  /**
   ...
   * })
  **/
  count<T extends FieldFormulaCountArgs>(
    args?: Prisma.Subset<T, FieldFormulaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FieldFormulaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends FieldFormulaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FieldFormulaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFieldFormulaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

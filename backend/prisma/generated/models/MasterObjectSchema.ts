...
// @ts-nocheck 
/*
 * This file exports the `MasterObjectSchema` model and its related types.
 *
...
export type GetMasterObjectSchemaAggregateType<T extends MasterObjectSchemaAggregateArgs> = {
      [P in keyof T & keyof AggregateMasterObjectSchema]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMasterObjectSchema[P]>
    : Prisma.GetScalarType<T[P], AggregateMasterObjectSchema[P]>
}
...
type GetMasterObjectSchemaGroupByPayload<T extends MasterObjectSchemaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MasterObjectSchemaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MasterObjectSchemaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MasterObjectSchemaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MasterObjectSchemaGroupByOutputType[P]>
      }
    >
  >
...
export type MasterObjectSchemaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MasterObjectSchemaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MasterObjectSchemaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MasterObjectSchema'], meta: { name: 'MasterObjectSchema' } }
  /**
   ...
   * })
  **/
  count<T extends MasterObjectSchemaCountArgs>(
    args?: Prisma.Subset<T, MasterObjectSchemaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MasterObjectSchemaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MasterObjectSchemaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MasterObjectSchemaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMasterObjectSchemaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
